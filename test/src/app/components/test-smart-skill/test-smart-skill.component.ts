...
@Component({
    templateUrl: './test-smart-skill.component.html',
    styleUrls: ['./test-smart-skill.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class TestSmartSkillComponent implements SmartSkillPresenter, OnChanges {
    @Input()
