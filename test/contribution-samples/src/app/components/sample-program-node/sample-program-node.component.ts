...
@Component({
    templateUrl: './sample-program-node.component.html',
    styleUrls: ['./sample-program-node.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})

export class SampleProgramNodeComponent implements OnChanges, ProgramPresenter {
    ...
    @Input() contributedNode: SampleProgramNodeNode;
