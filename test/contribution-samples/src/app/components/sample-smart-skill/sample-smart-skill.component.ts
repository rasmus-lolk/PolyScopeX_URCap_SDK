...
@Component({
    templateUrl: './sample-smart-skill.component.html',
    styleUrls: ['./sample-smart-skill.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SampleSmartSkillComponent implements SmartSkillPresenter, OnChanges {
    @Input()
